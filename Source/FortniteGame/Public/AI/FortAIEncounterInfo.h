...
#include "Missions/Generation/FortEncounterPawnNumberCaps.h"
#include "Engine/CurveTable.h"
#include "AI/Navigation/NavAgentInterface.h"
#include "GameplayTagContainer.h"
#include "Modifiers/GameplayMutatorObserverInterface.h"
...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnEncounterAllEnemiesKilled, UFortAIEncounterInfo*, Encounter);
...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnEncounterCompleted, UFortAIEncounterInfo*, Encounter, bool, bSuccessfullyCompleted);
