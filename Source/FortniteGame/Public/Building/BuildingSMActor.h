...
#include "Attributes/TierMeshSets.h"
#include "BuildingEditModeSupport.h"
#include "FortBuildings_Structs.h"
...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE(FRepairFinishedDelegate);
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TEnumAsByte<ELootQuotaLevel> MaximumQuotaLevelBound;
...
protected: // acually its private but doesnt't work with some code yes yes
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TEnumAsByte<EPlacementType> BuildingPlacementType;
