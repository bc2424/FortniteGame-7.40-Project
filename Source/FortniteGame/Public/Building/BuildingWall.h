...
#include "FortDoorLinkComponent.h"
...
class ABuildingWall : public ABuildingSMActor, public INavLinkCustomInterface {
    GENERATED_BODY()
public:
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
...
protected:
    ...
    TArray<UMaterialInstanceDynamic*> DoorAnimatingMIDs;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TEnumAsByte<ECollisionEnabled::Type> DoorDisabledCollisionSetting;
