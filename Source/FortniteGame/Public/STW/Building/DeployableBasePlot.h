...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnDeployableBaseCoreCreated, ADeployableBasePlot*, Plot, ADeployableBaseCore*, Core);
...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnDeployableBasePlotSpacesChanged);
