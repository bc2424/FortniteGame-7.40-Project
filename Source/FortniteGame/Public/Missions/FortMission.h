...
#include "Attributes/TieredModifierSetData.h"
...
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnMissionInfoSet);
UDELEGATE(BlueprintCallable) DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnObjectivesUpdated);
